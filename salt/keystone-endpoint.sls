...
keystone_endpoint_v3_RegionOne:
    keystone.endpoint_present:
        - name: keystone
        - publicurl: 'http://{{ keystoneusers.bind.public_address }}:{{ keystoneusers.bind.public_port }}/v3'
        - internalurl: 'http://{{ keystoneusers.bind.public_address }}:{{ keystoneusers.bind.public_port }}/v3'
...
keystone_endpoint_v2_RegionOne:
  keystone.endpoint_present:
  - name: keystone
  - publicurl: 'http://{{ keystoneusers.bind.public_address }}:{{ keystoneusers.bind.public_port }}/v2.0'
  - internalurl: 'http://{{ keystoneusers.bind.public_address }}:{{ keystoneusers.bind.public_port }}/v2.0'
...
swift_endpoint_regionOne:
  keystone.endpoint_present:
  - name: swift
  - publicurl: 'http://{{ swift.keystone_endpoint.public_address }}:{{ swift.keystone_endpoint.public_port }}/v1/AUTH_%\(tenant_id\)s'
  - internalurl: 'http://{{ swift.keystone_endpoint.public_address }}:{{ swift.keystone_endpoint.public_port }}/v1/AUTH_%\(tenant_id\)s'
  - adminurl: 'http://{{ swift.keystone_endpoint.address }}:{{ swift.keystone_endpoint.private_port }}/v1'
  - region: 'regionOne'
  - connection_token: {{ keystone_admin_token }}
  - connection_endpoint: 'http://{{ keystoneusers.bind.address }}:{{ keystoneusers.bind.private_port }}/v3'
  - require:
